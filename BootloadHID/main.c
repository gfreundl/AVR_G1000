...
* gfe Notes:
* see Notizen.txt
* bootloader condition needs to be met for whole flash operation!
* DBG is nop when DEBUG_LEVEL=0, not necessary to comment out
* BOOTRST Fuse is required, BOOT Sector lock optional
TEST_MODE used to verify report descriptor
*/
 ...
 */
//gfe: this dummy function makes program start from address 0x0000
    nullVector();				
}
